...
//authSelectors
export const selectRegisterStatus = (state: AppRootStateType): boolean =>
  state.auth.isRegistered;
export const selectLoginStatus = (state: AppRootStateType): boolean =>
  state.auth.isLoggedIn;
export const selectUserId = (state: AppRootStateType): string | undefined =>
  state.auth.user?._id;
...
export const selectRequestProcessingStatus = (
  state: AppRootStateType
): boolean => state.app.isRequestProcessing;
export const selectAppError = (state: AppRootStateType): string | null =>
  state.app.error;

//packsSelectors
export const selectPacksCountPerPage = (state: AppRootStateType): number =>
  state.packs.pageCount;
export const selectPacksTotalCount = (state: AppRootStateType): number =>
  state.packs.cardPacksTotalCount;
export const selectCurrentPacksPage = (state: AppRootStateType): number =>
  state.packs.page;
export const selectPackName = (state: AppRootStateType): string =>
  state.packs.packName;
export const selectAreMyPacksStatus = (state: AppRootStateType): boolean =>
  state.packs.areMyPacks;
export const selectPacks = (state: AppRootStateType): PackType[] =>
  state.packs.cardPacks; // for Search
export const selectMinCardsSearchParam = (
  state: AppRootStateType
): number | null => state.packs.min;
export const selectMaxCardsSearchParam = (
  state: AppRootStateType
): number | null => state.packs.max;
...
export const selectSortPacksParam = (state: AppRootStateType): string =>
  state.packs.sortPacks;

//cardsSelectors
export const selectCardsCountPerPage = (state: AppRootStateType): number =>
  state.cards.pageCount;
export const selectCardsTotalCount = (state: AppRootStateType): number =>
  state.cards.cardsTotalCount;
export const selectCurrentCardsPage = (state: AppRootStateType): number =>
  state.cards.page;
export const selectCards = (state: AppRootStateType): CardType[] =>
  state.cards.cards;
export const selectCardsListName = (state: AppRootStateType): string =>
  state.cards.packName;
export const selectCardQuestion = (state: AppRootStateType): string =>
  state.cards.cardQuestion; // for Search
export const selectPackUserId = (state: AppRootStateType): string =>
  state.cards.packUserId;
export const selectSortCardsParam = (state: AppRootStateType): string =>
